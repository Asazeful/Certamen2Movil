// ignore_for_file: unused_local_variable, body_might_complete_normally_nullable, unused_field
...
class AgregarLocalesScreen extends StatefulWidget {
   AgregarLocalesScreen({Key? key}) : super(key: key);

  @override
  
  State<AgregarLocalesScreen> createState() => _AgregarLocalesScreenState();
}

class _AgregarLocalesScreenState extends State<AgregarLocalesScreen> {
